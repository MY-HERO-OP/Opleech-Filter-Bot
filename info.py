...
URL = "https://opleech-filterbot-2fb8dcd18681.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://opleech-filterbot-2fb8dcd18681.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://opleech-filterbot-2fb8dcd18681.herokuapp.com/".format(FQDN)
else:
    URL = "https://opleech-filterbot-2fb8dcd18681.herokuapp.com/".format(FQDN)
